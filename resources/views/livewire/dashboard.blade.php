<div class="px-5 py-4">
    ...
    <div class="my-4">
        ...
        <div class="rounded-lg border-2 border-[#60C0D0] border-separate p-8 my-4">
            <h1 class="font-bold text-xl">Total Penerima</h1>
            <div class="flex flex-wrap justify-start gap-4">
                <div class="card bg-base-100 w-80 shadow-xl">
                    <div class="card-body">
                        <h2 class="card-title">Seluruh Penerima</h2>
                        <p class="font-bold text-3xl text-[#60C0D0]">{{ $total_penerima }}</p>
                    </div>
                </div>
                <div class="card bg-base-100 w-80 shadow-xl">
                    <div class="card-body">
                        <h2 class="card-title">Penerima Program PKH</h2>
                        <p class="font-bold text-3xl text-[#60C0D0]">{{ $penerima_pkh }}</p>
                    </div>
                </div>
                <div class="card bg-base-100 w-80 shadow-xl">
                    <div class="card-body">
                        <h2 class="card-title">Penerima Program BLT</h2>
                        <p class="font-bold text-3xl text-[#60C0D0]">{{ $penerima_blt }}</p>
                    </div>
                </div>
                <div class="card bg-base-100 w-80 shadow-xl">
                    <div class="card-body">
                        <h2 class="card-title">Penerima Program Bansos</h2>
                        <p class="font-bold text-3xl text-[#60C0D0]">{{ $penerima_bansos }}</p>
                    </div>
                </div>
                <div class="card bg-base-100 w-80 shadow-xl">
                    <div class="card-body">
                        <h2 class="card-title">Penerima Program RTLH</h2>
                        <p class="font-bold text-3xl text-[#60C0D0]">{{ $penerima_rtlh }}</p>
                    </div>
                </div>
            </div>
        </div>
